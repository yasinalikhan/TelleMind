-- =============================================================
-- V2: Seed Data (PostgreSQL)
-- BCrypt hashed passwords (rounds=12, compatible with Spring Security BCryptPasswordEncoder)
-- admin123  → $2b$12$B7Y/y96omiIVSsV8l0A83uGG3KElqyIPxS9H06huCdCPml05qgx5a
-- viewer123 → $2b$12$hWPfZL4PYAlLCiF0BiuSHOHOOqCJxIuwMegycYqq4jt.LArPIksKu
-- =============================================================

-- Seed Users (BCrypt hashed passwords)
INSERT INTO users (username, password, role, tenant_id) VALUES
('admin',        '$2b$12$B7Y/y96omiIVSsV8l0A83uGG3KElqyIPxS9H06huCdCPml05qgx5a', 'ROLE_ADMIN',  'tenant_1'),
('viewer',       '$2b$12$hWPfZL4PYAlLCiF0BiuSHOHOOqCJxIuwMegycYqq4jt.LArPIksKu', 'ROLE_VIEWER', 'tenant_1'),
('roshan_admin', '$2b$12$B7Y/y96omiIVSsV8l0A83uGG3KElqyIPxS9H06huCdCPml05qgx5a', 'ROLE_ADMIN',  'tenant_2')
ON CONFLICT (username) DO NOTHING;

-- Seed Subscribers (Tenant 1 — Afghan Wireless)
...
-- Seed for tenant_2 (isolation testing — Roshan Telecom)
('+93700112233', 'Kabul',           'Prepaid Monthly',      'Active',    400.00, '2025-02-15', 'tenant_2')
ON CONFLICT DO NOTHING;

-- Seed Daily Revenue — Last 31 Days (Tenant 1)
...
-- Tenant 2 isolation record
('2026-07-08', 'Kabul',          1500.00, 'Data',  'tenant_2')
ON CONFLICT DO NOTHING;

-- Seed Network Usage (Tenant 1)
